 ...
 * @author tauhid
 */
public class PDataPengguna extends javax.swing.JPanel {

    JFUtama utama;
    c_user cuser;
    /**
     * Creates new form PDataPengguna
     */
    public PDataPengguna(JFUtama utama) {
        initComponents();
        this.utama = utama;
    }
    ...
    private void initComponents() {
        ...
        InternalFrame.setTitle("Data Pengguna Aplikasi");
        ...
        ljumlahdata.setText("Jumlah Pengguna : ");
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
       ...
       new JFAddPengguna(this,utama).setVisible(true);
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        // TODO add your handling code here:
            ...
            int dialogResult = JOptionPane.showConfirmDialog (this, "Anda Yakin Akan Menghapus Pengguna Ini?","Peringatan",JOptionPane.WARNING_MESSAGE);
            if(dialogResult == JOptionPane.YES_OPTION){
                cuser = new c_user(this, this.utama);
                String id = tabel_data.getValueAt(tabel_data.getSelectedRow(),0).toString();
                cuser.delete(id);
                cuser.isiTabel();
            }
        } else {
            JOptionPane.showMessageDialog(this, "Pilih Data Pengguna Pada Tabel Sebelum Hapus","Pesan Kesalahan",JOptionPane.WARNING_MESSAGE);
        } 
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
        // TODO add your handling code here:
        if (tabel_data.getSelectedRow()>=0){
            JFAddPengguna user = new JFAddPengguna(this,this.utama);
            user.setAlwaysOnTop(true);
            user.setTitle("Form Ubah Data Pengguna");
            user.getJudul().setText("Form Edit Data User");
            user.getButton().setText("Update Pengguna");
            user.getID().setVisible(false);
            user.getID().setText(tabel_data.getValueAt(tabel_data.getSelectedRow(),0).toString());
            user.getUser().setText((String) tabel_data.getValueAt(tabel_data.getSelectedRow(),1));
            user.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "Pilih Data Pengguna Pada Tabel Sebelum Edit","Pesan Kesalahan",JOptionPane.WARNING_MESSAGE);
        }
