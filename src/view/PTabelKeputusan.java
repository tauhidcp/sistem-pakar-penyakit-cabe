 ...
 * @author tauhid
 */
public class PTabelKeputusan extends javax.swing.JPanel {

    JFUtama utama;
    c_keputusan tkeputusan;
    /**
     * Creates new form PTabelKeputusan
     */
    public PTabelKeputusan(JFUtama utama) {
        initComponents();
        this.utama = utama;
    }
    ...
    private void initComponents() {
        ...
        InternalFrame.setTitle("Tabel Keputusan");
        ...
        btn_refresh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/asset/Update_1.png"))); // NOI18N
        ...
        ljumlahdata.setText("Jumlah Keputusan (Aturan) : ");
    ...
    if (tabel_data.getSelectedRow()>=0){
            int dialogResult = JOptionPane.showConfirmDialog (this, "Anda Yakin Akan Menghapus Keputusan Ini?","Peringatan",JOptionPane.WARNING_MESSAGE);
            if(dialogResult == JOptionPane.YES_OPTION){
                tkeputusan = new c_keputusan(this, this.utama);
                String id = tabel_data.getValueAt(tabel_data.getSelectedRow(),0).toString();
                tkeputusan.delete(id);
                tkeputusan.isiTabel();
            }
        } else {
            JOptionPane.showMessageDialog(this, "Pilih Data Keputusan Pada Tabel Sebelum Hapus","Pesan Kesalahan",JOptionPane.WARNING_MESSAGE);
        } 
