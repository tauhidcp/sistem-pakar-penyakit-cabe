 ...
 * @author tauhid
 */
public class PDataGejala extends javax.swing.JPanel {

    JFUtama utama;
    c_gejala cgejala;
    /**
     * Creates new form PDataGejala
     */
    public PDataGejala(JFUtama utama) {
        initComponents();
        this.utama = utama;
    }
    ...
    private void initComponents() {
        ...
        InternalFrame.setTitle("Data Gejala Penyakit Cabe");
        ...
        ljumlahdata.setText("Jumlah Gejala : ");
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        new JFAddGejala(this,utama).setVisible(true);
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        ...
        if (tabel_data.getSelectedRow()>=0){
            int dialogResult = JOptionPane.showConfirmDialog (this, "Anda Yakin Akan Menghapus Gejala Ini?","Peringatan",JOptionPane.WARNING_MESSAGE);
            if(dialogResult == JOptionPane.YES_OPTION){
                cgejala = new c_gejala(this, this.utama);
                String id = tabel_data.getValueAt(tabel_data.getSelectedRow(),0).toString();
                cgejala.delete(id);
                cgejala.isiTabel();
            }
        } else {
            JOptionPane.showMessageDialog(this, "Pilih Data Gejala Pada Tabel Sebelum Hapus","Pesan Kesalahan",JOptionPane.WARNING_MESSAGE);
        } 
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
        // TODO add your handling code here:
        if (tabel_data.getSelectedRow()>=0){
            JFAddGejala user = new JFAddGejala(this,this.utama);
            user.setAlwaysOnTop(true);
            user.setTitle("Form Ubah Data Gejala");
            user.getJudul().setText("Form Edit Data Gejala");
            user.getButton().setText("Update Gejala");
            ...
            user.getPer().setText((String) tabel_data.getValueAt(tabel_data.getSelectedRow(),2));
            user.getDes().setText((String) tabel_data.getValueAt(tabel_data.getSelectedRow(),3));
            user.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "Pilih Data Gejala Pada Tabel Sebelum Edit","Pesan Kesalahan",JOptionPane.WARNING_MESSAGE);
        }
