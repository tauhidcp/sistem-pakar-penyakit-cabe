 ...
 * @author tauhid
 */
public class PDataPenyakit extends javax.swing.JPanel {
     ...
     */
    public PDataPenyakit(JFUtama utama) {
        initComponents();
        this.utama = utama;
    }
    ...
    private void initComponents() {
        ...
        InternalFrame.setTitle("Data Penyakit Cabe");
        ...
        ljumlahdata.setText("Jumlah Penyakit : ");
    ...
    private void btn_tambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        new JFAddPenyakit(this,utama).setVisible(true);
    ...
    private void btn_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hapusActionPerformed
        // TODO add your handling code here:
            ...
            int dialogResult = JOptionPane.showConfirmDialog (this, "Anda Yakin Akan Menghapus Penyakit Ini?","Peringatan",JOptionPane.WARNING_MESSAGE);
            if(dialogResult == JOptionPane.YES_OPTION){
                cpenyakit = new c_penyakit(this, this.utama);
                String id = tabel_data.getValueAt(tabel_data.getSelectedRow(),0).toString();
                cpenyakit.delete(id);
                cpenyakit.isiTabel();
            }
        } else {
            JOptionPane.showMessageDialog(this, "Pilih Data Penyakit Pada Tabel Sebelum Hapus","Pesan Kesalahan",JOptionPane.WARNING_MESSAGE);
        } 
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
        // TODO add your handling code here:
        if (tabel_data.getSelectedRow()>=0){
            JFAddPenyakit user = new JFAddPenyakit(this,this.utama);
            user.setAlwaysOnTop(true);
            user.setTitle("Form Ubah Data Penyakit");
            user.getJudul().setText("Form Edit Data Penyakit");
            user.getButton().setText("Update Penyakit");
            ...
            JOptionPane.showMessageDialog(this, "Pilih Data Penyakit Pada Tabel Sebelum Edit","Pesan Kesalahan",JOptionPane.WARNING_MESSAGE);
        }
